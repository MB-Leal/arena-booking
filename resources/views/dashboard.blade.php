...
            <!-- BARRA DE NAVEGAÇÃO: Flexível e com quebra de linha -->
            <nav class="flex items-center flex-wrap gap-3 mt-2 sm:mt-0">

                <!-- BOTÃO PRINCIPAL (Cor de Destaque) -->
...
                <!-- NOVO BOTÃO: Reservas Confirmadas (Link direto) -->
                <a href="http://192.168.0.50:8000/admin/reservas/confirmadas" class="w-full sm:w-auto text-sm font-medium px-3 py-2 rounded-lg bg-indigo-600 hover:bg-indigo-500 transition duration-150 text-center">
                    Reservas Confirmadas
                </a>
               
                @if(isset($reservasPendentesCount) && $reservasPendentesCount > 0)
                    <!-- Botão de Notificação (Badged Icon) -->
                    <a href="{{ route('admin.reservas.index') }}" class="w-full sm:w-auto relative inline-flex items-center justify-center px-3 py-2 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 transition duration-150 ease-in-out">
